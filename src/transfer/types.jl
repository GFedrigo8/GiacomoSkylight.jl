...
@with_kw mutable struct NonVacuumThreadCache{SC, MC, CC}
    acceleration::Vector{Float64} = zeros(4)
...
@with_kw mutable struct NonVacuumCache{S, M, C, SC, MC, CC, CT}
    spacetime::S
    model::M
    ...
    NE::Int
    multi_thread::Vector{NonVacuumThreadCache{SC, MC, CC}}
end
