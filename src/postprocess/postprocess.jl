...
function task_init(configurations::VacuumOTEConfigurations; kwargs...)
    task_init(configurations.camera, configurations; kwargs...)
end
...
function task_init(camera::PinholeCamera,
